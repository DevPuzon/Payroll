...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
              ...
              method="POST" action="employee_add.php"
               enctype="multipart/form-data">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9"> 
                      <div class="date">
                        <input required type="text" class="form-control" id="datepicker_add" name="birthdate">
                      </div>
                  	</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="department" id="department" >
                        ...
                        <?php
                          ...
                          while($prow = $query->fetch_assoc()){
                            echo "
                              <option value='".$prow['col_departmentid']."'>".$prow['col_department']."</option>
                            ";
                          }
                        ?>
                      </select>
                      ...
                      <select class="form-control" id="schedule" name="schedule" >
                        ...
                        <?php
                          ...
                          while($srow = $query->fetch_assoc()){
                            ...
                            if($srow['col_is_flexi']){
                              echo "
                              <option value='".$srow['id']."'>".'Flexi'."</option>
                               "; 
                            }
                          }
                          $sql = "SELECT * FROM schedules";
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="department" id="edit_department">
                        ...
                        <?php
                          ...
                          while($prow = $query->fetch_assoc()){
                            echo "
                              <option value='".$prow['tbl_departmentid']."'>".$prow['col_department']."</option>
                            ";
                          }
                        ?>
                      </select>
