    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="ratepermonth" class="col-sm-3 control-label">Rate per month</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="ratepermonth" name="ratepermonth" required>
                    </div>
                </div>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_ratepermonth" class="col-sm-3 control-label">Rate per month</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_ratepermonth" name="edit_ratepermonth" required>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
